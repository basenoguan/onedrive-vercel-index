...
module.exports = {
  ...
  userPrincipalName: process.env.NEXT_PUBLIC_USER_PRINCIPLE_NAME || 'ondrive1@6h11g2.onmicrosoft.com',
  ...
  protectedRoutes: ['/Public/SomethingIT'],
